...
dev::Address createTachacoinAddress(dev::h256 hashTx, uint32_t voutNumber){
...
TachacoinTransaction createTachacoinTransaction(valtype data, dev::u256 value, dev::u256 gasLimit, dev::u256 gasPrice, dev::h256 hashTransaction, dev::Address recipient, int32_t nvout){
...
std::pair<std::vector<ResultExecute>, ByteCodeExecResult> executeBC(std::vector<TachacoinTransaction> txs){
