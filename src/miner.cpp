...
bool BlockAssembler::AttemptToAddContractToBlock(CTxMemPool::txiter iter, uint64_t minGasPrice) {
    ...
    TachacoinTxConverter convert(iter->GetTx(), NULL, &pblock->vtx);
    ...
    ByteCodeExec exec(*pblock, tachacoinTransactions, hardBlockGasLimit);
...
void ThreadStakeMiner(CWallet *pwallet)
{
    ...
    RenameThread("tachacoincoin-miner");
...
void StakeTachacoins(bool fStake, CWallet *pwallet)
{
