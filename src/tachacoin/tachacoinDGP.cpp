#include "tachacoinDGP.h"

void TachacoinDGP::initDataEIP158(){
...
bool TachacoinDGP::checkLimitSchedule(const std::vector<uint32_t>& defaultData, const std::vector<uint32_t>& checkData){
...
dev::eth::EVMSchedule TachacoinDGP::getGasSchedule(unsigned int blockHeight){
    clear();
...
dev::eth::EVMSchedule TachacoinDGP::createEVMSchedule(){
    dev::eth::EVMSchedule schedule = dev::eth::EIP158Schedule;
