...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s tachacoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  tachacoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded tachacoin transaction") + "\n" +
              "  tachacoin-tx [options] -create [commands]   " + _("Create hex-encoded tachacoin transaction") + "\n" +
              "\n";
...
static void MutateTxAddInput(CMutableTransaction& tx, const std::string& strInput)
{
    ...
    static const unsigned int maxVout = dgpMaxBlockSize / minTxOutSz; // tachacoin
