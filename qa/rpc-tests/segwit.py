...
from test_framework.address import script_to_p2sh, key_to_p2pkh, keyhash_to_p2pkh, scripthash_to_p2sh, convert_btc_address_to_tachacoin
...
def create_witnessprogram(version, node, utxo, pubkey, encode_p2sh, amount):
    ...
    DUMMY_P2SH = convert_btc_address_to_tachacoin("2MySexEGVzZpRgNQ1JdjdP5bRETznm3roQ2") # P2SH of "OP_1 OP_DROP"
